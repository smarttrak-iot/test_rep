...
button =html.Div(
           dbc.Row(
              [
                  dbc.Col(dbc.Button("Login",color="primary",className="mb-3",href="#"),style={"padding-left":"30rem","width":"5rem"})]))
navbar = dbc.Navbar(
           html.Div(
                ...
                dbc.Row(
                    [
                        dbc.Col(
                            dbc.NavbarBrand(
                                html.H2((html.Img(src=LOGO1,height="90px",width="auto"))),style={"fontSize":"50px","padding-left":"30rem"})),
